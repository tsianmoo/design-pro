<template>
  <div class="page-content">
    ...
    <div class="row">
      <h3>菜单权限</h3>
      <p>菜单权限通过后端接口返回的菜单数据结构控制，如果数据结构存在菜单就会显示</p>
      <p>系统会根据用户角色权限动态加载对应的菜单</p>
    ...
    <div class="row">
      ...
      >
      <el-row>
        <el-button v-auth="'add'" type="primary" size="small">新增</el-button>
        <el-button v-auth="'edit'" type="default" size="small">编辑</el-button>
        <el-button v-auth="'delete'" type="danger" size="small">删除</el-button>
      </el-row>
